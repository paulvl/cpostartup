  ...
  return (
    <footer className="bg-slate-50">
      <Container>
        ...
        <div className="flex flex-col items-center py-10 border-t border-slate-400/10 sm:flex-row-reverse sm:justify-center">
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} CPO Startup. {t('copyright')}
          </p>
        </div>
      </Container>
    </footer>
