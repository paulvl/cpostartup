      ...
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          <h2 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
            Simplifica y potencia tu operación.
          </h2>
          <p className="mt-4 text-lg tracking-tight text-slate-700">
            ¿Te faltan manos? ¿Necesitas más capacidad? Somos más que expertos en tecnología, entendemos la velocidad a la que se mueve una startup, las muchas tareas pendientes con un equipo ocupado y la resiliencia necesaria para hacerlas todas.
          </p>
        </div>
        <FeaturesMobile />
        <FeaturesDesktop />
